...
/**
 * check_elf - Checks the file to know if it is an ELF file.
 * @e_ident: Points to an array containing the ELF magic numbers.
 *
 * Description: Exit code 98 if file not ELF.
 */
void check_elf(unsigned char *e_ident)
{
	int i;
...
/**
 * print_magic - Outputs the magic numbers of an ELF header.
 * @e_ident: Points to an array containing the ELF magic numbers.
 *
...
/**
 * print_version - Outputs the version of an ELF header.
